...
System.Console.WriteLine($"Доступна ли скидка?: {eligibleForDiscount}");
System.Console.WriteLine($"Сумма покупки: {summa}");
System.Console.WriteLine($"Имеется ли карта лояльности?: {karta}");
System.Console.WriteLine($"Кол-во товаров в чеке: {tovarov}");